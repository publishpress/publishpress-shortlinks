 ...
 *
 */
if (! class_exists('WPDK_Settings_Taxonomy_Options')) {
    class WPDK_Settings_Taxonomy_Options extends WPDK_Settings_Abstract
    {
        // constans
        public $unique = '';
        public $taxonomy = '';
                ...
                if ($taxonomy === $this->taxonomy) {
                    ...
                    if (! empty($section['fields'])) {
                        foreach ($section['fields'] as $field) {
                            ...
                            WPDK_Settings::field($field, $this->get_meta_value($field, $term_id), $this->unique, 'taxonomy');
                        }
                    }
                }
            }
