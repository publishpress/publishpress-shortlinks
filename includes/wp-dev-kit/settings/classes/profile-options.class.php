 ...
 *
 */
if (! class_exists('WPDK_Settings_Profile_Options')) {
    class WPDK_Settings_Profile_Options extends WPDK_Settings_Abstract
    {
        // constans
        public $unique = '';
            ...
            foreach ($this->sections as $section) {
                ...
                if (! empty($section['fields'])) {
                    foreach ($section['fields'] as $field) {
                        ...
                        WPDK_Settings::field($field, $this->get_meta_value($profile_id, $field), $this->unique, 'profile');
                    }
                }
            }
