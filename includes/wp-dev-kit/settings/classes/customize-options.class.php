    ...
    class WPDK_Settings_Customize_Options extends WPDK_Settings_Abstract
    {
      ...
      // save defaults and set new fields value to main options
        ...
        public function add_customize_options($wp_customize)
        {
            ...
            if (! class_exists('WP_Customize_Panel_WPDK_Settings')) {
                WPDK_Settings::include_plugin_file('functions/customize.php');
            }
        ...
        public function add_section($wp_customize, $section_id, $section_args, $panel_id)
        {
            ...
            if (! empty($section_args['fields'])) {
                ...
                foreach ($section_args['fields'] as $field) {
                    ...
                    $wp_customize->add_control(new WP_Customize_Control_WPDK_Settings(
                        $wp_customize,
                        $setting_id,
