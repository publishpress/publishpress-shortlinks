 ...
 *
 */
if (! class_exists('WPDK_Settings_Widget')) {
    class WPDK_Settings_Widget extends WP_Widget
    {
      // constans
        public $unique  = '';
        public $args    = array(
        ...
        public function form($instance)
        {
            ...
            if (! empty($this->args['fields'])) {
                ...
                foreach ($this->args['fields'] as $field) {
                    ...
                    WPDK_Settings::field($field, $this->get_widget_value($instance, $field), $field_unique);
                }
