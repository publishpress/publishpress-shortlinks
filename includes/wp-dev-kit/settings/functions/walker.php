 ...
 *
 */
if (! class_exists('WPDK_Settings_Walker_Nav_Menu_Edit') && class_exists('Walker_Nav_Menu_Edit')) {
    class WPDK_Settings_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit
    {
