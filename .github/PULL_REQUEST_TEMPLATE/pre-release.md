...
- [ ] Create and merge a Pull Request for the release branch into the `master` branch. Delete the release branch.
- [ ] Establish the GitHub release on the `master` branch with the correct tag.
- [ ] Merge the `master` branch into the `development` branch.
- [ ] Follow up with the deployment process on the [GitHub Actions](https://github.com/publishpress/PublishPress-shortlinks/actions) page.
