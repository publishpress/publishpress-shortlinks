...
* Fixed: Analytics subtabs aren't clickable, #74
* Fixed: Custom URL doesn't update, #96
...
* Update: Translation Updates ES-FR-IT, #87
...
* Fixed: Function _load_textdomain_just_in_time error, #10
* Fixed: PHP 8.2+ dynamic property deprecation warnings in WPDK framework, #11
...
* Fixed: Readme updated with more content.
...
* Fixed: WordPress version update.
...
* Fixed: New readme text update.

= [1.0.5] - 15 April, 2023 =

* Fixed: New WordPress version update.
...
* Fixed: Empty input fields validation.
